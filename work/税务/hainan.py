...
def getInfo(i):
    url='http://hainan.chinatax.gov.cn/bsfw_5_8/'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='海南长宏康实业有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="weifaCaseSearchForm"]/div[1]/span[2]/input').send_keys(nsrmc)
    time.sleep(1)
    driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[2]/div[2]/div[1]/button[2]').click()
    time.sleep(3)
    result=driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[2]/div[2]/div[2]/div/div').get_attribute('innerHTML')
    #print(result)
    if re.findall(r"暂时没有数据",result):
        print('无符合公布标准的案件信息')
        driver.quit()
        exit(0)
    else:
        driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[2]/div[2]/div[2]/div/div/table[2]/tbody/tr['+str(i)+']/td[5]/input').click()
        time.sleep(1)
        info=driver.find_element_by_xpath('//*[@id="detailDiv"]/table/tbody').get_attribute('innerHTML')
        #print(info)
...
/html/body/div[4]/div[2]/div[2]/div[2]/div[2]/div/div/table[2]/tbody/tr[1]/td[5]/input
/html/body/div[4]/div[2]/div[2]/div[2]/div[2]/div/div/table[2]/tbody/tr[2]/td[5]/input
/html/body/div[4]/div[2]/div[2]/div[2]/div[2]/div/div/table[2]/tbody/tr[5]/td[5]/input
