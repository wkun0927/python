...
def getInfo(i):
    ...
    driver=getDriver()
    driver.get(url)
    driver.switch_to.frame('fcd29')
    driver.switch_to.frame('top')
    #纳税人名称
    nsrmc='南京越胜智能技术有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="vc_name"]').send_keys(nsrmc)
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="form1"]/input[2]').click()
    time.sleep(1)
    ...
    if re.findall(r"很遗憾，没有检索到任何记录！",result):
        ...
        driver.find_element_by_xpath('//*[@id="jpage"]/div/div/table[2]/tbody/tr['+str(i)+']/td/a').click()
        driver.switch_to.default_content()
        driver.switch_to.frame('fcd29')
        driver.switch_to.frame('right')
...
'''
//*[@id="jpage"]/div/div/table[2]/tbody/tr[1]
