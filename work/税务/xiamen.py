...
def getInfo(i):
    url='http://xiamen.chinatax.gov.cn/xmswcms/wycx/zdss.html'
    driver=getDriver()
    driver.get(url)
    ...
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="btn"]/input[2]').click()
    time.sleep(1)
    driver.switch_to.default_content()
    driver.switch_to.frame('content')
    result=driver.find_element_by_xpath('//*[@id="freeTable"]/tbody/tr').get_attribute('innerHTML')
    if re.findall(r"没有找到相关数据",result):
        ...
        # driver.switch_to.default_content()
        # driver.switch_to.frame('content')
        driver.find_element_by_xpath('//*[@id="freeTable"]/tbody/tr['+str(i)+']/td[5]').click()
        driver.switch_to.default_content()
        time.sleep(1)
        driver.switch_to.frame('content')
        driver.switch_to.frame('layui-layer-iframe1')
        info=driver.find_element_by_xpath('//*[@id="table_content"]/tbody').get_attribute('innerHTML')
        #print(info)
...
'''
//*[@id="freeTable"]/tbody/tr[1]/td[5]
//*[@id="freeTable"]/tbody/tr[2]/td[5]
//*[@id="freeTable"]/tbody/tr[10]/td[5]
'''