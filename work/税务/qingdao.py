...
def getInfo(i):
    url='http://qingdao.chinatax.gov.cn/resourcedata/sswf2019/'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='青岛金隆顺盛商贸有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="txttitle"]').send_keys(nsrmc)
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="pc_sswfbtnsearch"]').click()
    time.sleep(3)
    driver.switch_to.frame('right')

    result=driver.find_element_by_xpath('/html/body/div').get_attribute('innerHTML')
    if re.findall(r"无符合公布标准的案件信息",result):
        ...
        driver.find_element_by_xpath('/html/body/table/tbody/tr['+str(i)+']/td[5]/a').click()
        all_h=driver.window_handles
        driver.switch_to.window(all_h[1])
        info=driver.find_element_by_xpath('//*[@id="area"]/div/div[3]/div[1]/table/tbody/tr/td/table/tbody').get_attribute('innerHTML')
        #print(info)
...
/html/body/table/tbody/tr[7]/td[5]/a
/html/body/table/tbody/tr[6]/td[5]/a
'''