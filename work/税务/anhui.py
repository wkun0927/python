...
def getInfo(i):
    url = 'http://anhui.chinatax.gov.cn/module/jslib/bulletin/index.html'
    driver = getDriver()
    driver.get(url)
    ...
    if re.findall(r"很遗憾，没有检索到任何记录！", result):
        ...
        driver.switch_to.default_content()
        driver.switch_to.frame('right')
        info = driver.find_element_by_xpath('/html/body/div[2]/table/tbody').get_attribute('innerHTML')
...
//*[@id="jpage"]/div/table[2]/tbody/tr/td[5]/div/a
//*[@id="jpage"]/div/table[2]/tbody/tr[1]/td[5]/div/a
//*[@id="jpage"]/div/table[2]/tbody/tr[1]/td[5]/div/a
//*[@id="jpage"]/div/table[2]/tbody/tr[2]/td[5]/div/a
'''
