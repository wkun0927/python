...
def getInfo(i):
    url='https://sichuan.chinatax.gov.cn/col/col14253/index.html'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='成都市聚益鑫物资有限公司'
    ...
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="searchTable"]/tbody/tr[9]/td/input[9]').click()
    time.sleep(3)
    driver.switch_to.frame('showIframe')

    result=driver.find_element_by_xpath('/html/body/form').get_attribute('innerHTML')
    if re.findall(r"共&nbsp;0&nbsp;页&nbsp;到第",result):
        print('无符合公布标准的案件信息')
        driver.quit()
        exit(0)
    else:
        driver.find_element_by_xpath('/html/body/table[2]/tbody/tr['+str(i)+']/td/table/tbody/tr/td[5]/a').click()
        all_h=driver.window_handles
        driver.switch_to.window(all_h[1])
        info=driver.find_element_by_xpath('//*[@id="barrierfree_container"]/div[3]/div/div[2]/div[5]/div/div/div/ul/table/tbody').get_attribute('innerHTML')
        #print(info)
...
/html/body/table[2]/tbody/tr[1]/td/table/tbody/tr/td[5]/a
/html/body/table[2]/tbody/tr[2]/td/table/tbody/tr/td[5]/a
/html/body/table[2]/tbody/tr[5]/td/table/tbody/tr/td[5]/a
