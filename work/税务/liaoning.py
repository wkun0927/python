...
def getInfo(i):
    url = 'http://liaoning.chinatax.gov.cn/col/col5883/index.html'
    driver = getDriver()
    driver.get(url)
    # 纳税人名称
    nsrmc = '辽宁麒畅贸易有限公司'
    # nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="FormSearchTest"]/ul[1]/li[1]/input').send_keys(nsrmc)
    time.sleep(1)
    ...
    if re.findall(r"共&nbsp;0&nbsp;页", result):
        ...
        info = driver.find_element_by_xpath('//*[@id="page_type"]/div[3]/div/div[5]/table/tbody').get_attribute('innerHTML')
        # print(info)
...
/html/body/div/table[3]/tbody/tr[6]/td[5]/a
/html/body/div/table[3]/tbody/tr[10]/td[5]/a
/html/body/div/table[3]/tbody/tr[12]/td[5]/a
