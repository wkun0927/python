...
def getInfo(i):
    ...
    driver.find_element_by_xpath(
        '//*[@id="container"]/div/div[2]/table/tbody/tr/td[3]/table[1]/tbody/tr/td/table/tbody/tr[4]/td/input').click()
    time.sleep(1)
    result = driver.find_element_by_xpath('//*[@id="righty2_table"]/tbody/tr[2]').get_attribute('innerHTML')
    # print(result)
    if re.findall(r"查询无数据", result):
        print("无符合公布标准的案件信息")
        driver.quit()
        exit(0)
    else:
        driver.find_element_by_xpath('//*[@id="righty2_table"]/tbody/tr['+str(i)+']').click()
        time.sleep(2)
        info = driver.find_element_by_xpath('//*[@id="righty3"]').get_attribute('innerHTML')
        # print(info)
        ...
        info7 = str(info6).replace("、'", "'").replace("、", ":").replace('&nbsp;','')
        print(info7)
    driver.quit()
...
//*[@id="righty2_table"]/tbody/tr[2]
//*[@id="righty2_table"]/tbody/tr[5]/td[1]
//*[@id="righty2_table"]/tbody/tr[21]
'''