...
def getInfo(i):
    url = 'http://chongqing.chinatax.gov.cn/xxgkxt/pages/qywh/zdwfajcx.html'
    driver = getDriver()
    driver.get(url)
    time.sleep(2)
    # 纳税人名称
    nsrmc = '重庆君钠商贸有限公司'
    # nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="search_nsrmc"]').send_keys(nsrmc)
    time.sleep(2)
    driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[1]/div/span[2]').click()
    time.sleep(4)
    result = driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[2]/div[2]').get_attribute('innerHTML')
    # print(result)
    if not re.findall(r"详细信息", result):
        ...
        driver.find_element_by_xpath(
            '/html/body/div[4]/div[2]/div[2]/div[2]/table[2]/tbody/tr[' + str(i) + ']/td[5]/span').click()
        time.sleep(0.5)
        info = driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[2]/div[3]/table/tbody').get_attribute(
            'innerHTML')
        # print(info)
...
'''
/html/body/div[4]/div[2]/div[2]/div[2]/table[2]/tbody/tr[1]/td[5]/span
/html/body/div[4]/div[2]/div[2]/div[2]/table[2]/tbody/tr[2]/td[5]/span
'''
