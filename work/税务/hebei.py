...
def getInfo(i):
    url='http://wzyy.hebei.chinatax.gov.cn/LawPublicity/law/adPenalty/taxDishonestyCases'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='唐山市君瑞房地产开发有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="form-horizontal"]/div[1]/div[1]/div/input').send_keys(nsrmc)
    time.sleep(0.5)
    driver.find_element_by_xpath('//*[@id="form-horizontal"]/div[5]/div/button[1]').click()
    time.sleep(0.5)

    result=driver.find_element_by_xpath('//*[@id="bootstrap-table"]/tbody').get_attribute('innerHTML')
    if re.findall(r"本税务机关尚未产生此信息",result):
        print('无符合公布标准的案件信息')
        driver.quit()
        exit(0)
    else:
        driver.find_element_by_xpath('//*[@id="bootstrap-table"]/tbody/tr['+str(i)+']/td[1]/a').click()
        time.sleep(1)
        all_h=driver.window_handles
        driver.switch_to.window(all_h[1])
        info=driver.find_element_by_xpath('/html/body/div[3]/div/div/div[4]/table/tbody').get_attribute('innerHTML')
        #print(info)
...
'''
//*[@id="bootstrap-table"]/tbody/tr[1]/td[1]/a
//*[@id="bootstrap-table"]/tbody/tr[2]/td[1]/a
//*[@id="bootstrap-table"]/tbody/tr[10]/td[1]/a
'''