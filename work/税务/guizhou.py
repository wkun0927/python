...
def getInfo(i):
    url = 'http://guizhou.chinatax.gov.cn/zdsswfsxajxxgbl/index.html'
    driver = getDriver()
    driver.get(url)
    # 纳税人名称
    nsrmc = '贵州顺信亚商贸有限责任公司'
    ...
    driver.find_element_by_xpath(
        '//*[@id="wrapper"]/table/tbody/tr[1]/td[3]/form/table/tbody/tr/td/table[5]/tbody/tr/td[3]/a/span').click()
    time.sleep(3)

    result = driver.find_element_by_xpath(
        '//*[@id="wrapper"]/table/tbody/tr[2]/td[2]/table[1]/tbody/tr/td/table[2]').get_attribute('innerHTML')
    if re.findall(r"无符合公布标准的案件信息", result):
        ...
        driver.find_element_by_xpath('//*[@id="idData"]/tr['+str(i)+']/td[6]/a').click()
        all_h = driver.window_handles
        driver.switch_to.window(all_h[0])
        info = driver.find_element_by_xpath('/html/body/div[2]/div[2]/table/tbody/tr/td/table/tbody').get_attribute('innerHTML')
        # print(info)
...
//*[@id="idData"]/tr[1]/td[6]/a
//*[@id="idData"]/tr[2]/td[6]/a
//*[@id="idData"]/tr[10]/td[6]/a
