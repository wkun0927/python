...
def getInfo(i):
    url='http://guangxi.chinatax.gov.cn/nsfw/sscx/sswfanj/'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    #nsrmc='柳州晁旭商贸有限公司'
    nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="nsr_name"]').send_keys(nsrmc)
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="search_table"]/tbody/tr/td/form/table/tbody/tr[5]/td[3]/a/span').click()
    time.sleep(10)
    result=driver.find_element_by_xpath('//*[@id="documentContainer"]/table[2]/tbody/tr/td').get_attribute('innerHTML')
    if re.findall(r"没有找到相关数据",result):
        ...
        driver.find_element_by_xpath('//*[@id="documentContainer"]/table[2]/tbody/tr['+str(i)+']/td[5]/a').click()
        all_h=driver.window_handles
        driver.switch_to.window(all_h[1])
        info=driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[7]/div[2]/table/tbody').get_attribute('innerHTML')
        #print(info)
...
'''
//*[@id="documentContainer"]/table[2]/tbody/tr[1]/td[5]/a
//*[@id="documentContainer"]/table[2]/tbody/tr[2]/td[5]/a
//*[@id="documentContainer"]/table[2]/tbody/tr[10]/td[5]/a
'''