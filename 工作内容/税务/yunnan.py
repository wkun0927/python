...
def getInfo(i):
    url = 'https://yunnan.chinatax.gov.cn/bulletin/index.html'
    driver = getDriver()
    driver.get(url)
    ...
    if re.findall(r"很遗憾，没有检索到任何记录", result):
        ...
        driver.find_element_by_xpath('/html/body/div/div/table[2]/tbody/tr['+str(i)+']/td[5]/div/a').click()
        driver.switch_to.default_content()
        time.sleep(0.5)
        driver.switch_to.frame('right')
        info = driver.find_element_by_xpath('/html/body/div/table/tbody').get_attribute('innerHTML')
        ...
        info10 = str(info9).replace("、'", "'").replace("、", ":")
        print(info10)
    driver.quit()
...
'''
/html/body/div/div/table[2]/tbody/tr/td[5]/div/a
/html/body/div/div/table[2]/tbody/tr[1]/td[5]/div/a
/html/body/div/div/table[2]/tbody/tr[2]/td[5]/div/a
'''