...
def getInfo(i):
    url='http://ningxia.chinatax.gov.cn/col/col12847/index.html'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='宁夏汇翔驰鑫科技有限公司'
    ...
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="FormSearchTest"]/div/input[8]').click()
    time.sleep(3)
    ...
    if re.findall(r"共&nbsp;0&nbsp;页&nbsp;到第",result):
        ...
        driver.find_element_by_xpath('/html/body/table[2]/tbody/tr['+str(i)+']/td[5]/a').click()
        time.sleep(2)
        driver.switch_to.default_content()
        driver.switch_to.frame('showIframe')
        info = driver.find_element_by_xpath('/html/body/div[4]/div/div/div[5]/div/div/div/ul/table/tbody/tr/td/table/tbody').get_attribute('innerHTML')
...
'''
/html/body/table[2]/tbody/tr[2]/td[5]/a
/html/body/table[2]/tbody/tr[4]/td[5]/a
/html/body/table[2]/tbody/tr[8]/td[5]/a
'''