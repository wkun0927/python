...
def getInfo(i):
    url='http://tianjin.chinatax.gov.cn/wzcx/cx_zdwfaj.action'
    driver=getDriver()
    driver.get(url)
    #切换到总查询页
    driver.find_element_by_xpath('//*[@id="11200000000"]').click()
    driver.switch_to.frame('showInfo')
    #纳税人名称
    nsrmc='天津正达源商贸有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    ...
    time.sleep(0.5)
    result=driver.find_element_by_xpath('/html/body/div[1]/table/tbody/tr/td/table/tbody/tr[2]').get_attribute('innerHTML')
    #print(result)
    if re.findall(r"没有检索到您要查询的信息",result):
        print("没有检索到您要查询的信息")
        driver.quit()
        exit(0)
    else:
        driver.find_element_by_xpath('/html/body/div[1]/table/tbody/tr/td/table/tbody/tr['+str(i)+']/td[5]/span').click()
        time.sleep(0.5)
        info = driver.find_element_by_xpath('//*[@id="showmxxx"]/table/tbody/tr[2]/td/table/tbody').get_attribute('innerHTML')
...
'''
/html/body/div[1]/table/tbody/tr/td/table/tbody/tr[2]/td[5]/span
/html/body/div[1]/table/tbody/tr/td/table/tbody/tr[15]/td[5]/span
/html/body/div[1]/table/tbody/tr/td/table/tbody/tr[21]/td[5]/span
'''
