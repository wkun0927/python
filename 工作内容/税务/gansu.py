...
def getInfo(i):
    url='http://gansu.chinatax.gov.cn/col/col8350/index.html'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='甘肃博中锐商贸有限公司'
    ...
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="searchTable"]/div[10]/input[9]').click()
    time.sleep(1)
    ...
    if re.findall(r"共&nbsp;0&nbsp;页&nbsp;到第",result):
        ...
        driver.find_element_by_xpath('/html/body/table[2]/tbody/tr['+str(i)+']/td/table/tbody/tr/td[4]/a').click()
        time.sleep(1)
        driver.switch_to.default_content()
        driver.switch_to.frame('showIframe')
        info=driver.find_element_by_xpath('//*[@id="barrierfree_container"]/div/div/div/table/tbody').get_attribute('innerHTML')
        #print(info)
...
/html/body/table[2]/tbody/tr[1]/td/table/tbody/tr/td[4]/a
/html/body/table[2]/tbody/tr[11]/td/table/tbody/tr/td[4]
