...
def getInfo(i):
    url='https://etax.xinjiang.chinatax.gov.cn/zdsswfaj/pages/swmh/wfcx.html'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='霍尔果斯华联贸易有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="cxtjForm"]/table/tbody/tr[1]/td[1]/span/span/input').send_keys(nsrmc)
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="submit"]/span').click()
    time.sleep(3)
    #driver.switch_to.frame('rightiframe')

    result=driver.find_element_by_xpath('//*[@id="nodata-text"]').get_attribute('innerHTML')
    if re.findall(r"无符合公布标准的案件信息",result):
        ...
        time.sleep(1)
        driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[2]/div[1]/div/div/div[3]/div[1]/table/tbody/tr['+str(i)+']/td[5]/a').click()
        time.sleep(1)
        info=driver.find_element_by_xpath('//*[@id="formdetal"]/tbody').get_attribute('innerHTML')
        #print(info)
...
/html/body/div[3]/div[2]/div[2]/div[1]/div/div/div[3]/div[1]/table/tbody/tr[2]/td[5]/a
/html/body/div[3]/div[2]/div[2]/div[1]/div/div/div[3]/div[1]/table/tbody/tr[3]/td[5]/a
/html/body/div[3]/div[2]/div[2]/div[1]/div/div/div[3]/div[1]/table/tbody/tr[11]/td[5]/a
