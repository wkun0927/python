...
def getInfo(i):
    url='http://hunan.chinatax.gov.cn/hardcase/20190408002097'
    driver=getDriver()
    driver.get(url)
    #纳税人名称
    nsrmc='湖南猛瑞汪建材有限公司'
    #nsrmc='北京字节跳动科技有限公司'
    driver.find_element_by_xpath('//*[@id="taxpayerName"]').send_keys(nsrmc)
    time.sleep(2)
    driver.find_element_by_xpath('//*[@id="main"]/div[4]/div[1]/div/div/div[2]/button').click()
    time.sleep(2)
    result=driver.find_element_by_xpath('//*[@id="main"]/div[4]/div[2]').get_attribute('innerHTML')
    #print(result)
    if not re.findall(r"详细信息",result):
        ...
        driver.find_element_by_xpath('//*[@id="dataList"]/tr['+str(i)+']/td[5]/a').click()
        time.sleep(1)
        info = driver.find_element_by_xpath('//*[@id="detailDy"]/tbody').get_attribute('innerHTML')
...
if __name__ == '__main__':
    try:
        ...
        exit(1)
'''
//*[@id="dataList"]/tr[2]/td[5]/a
//*[@id="dataList"]/tr[3]/td[5]/a
//*[@id="dataList"]/tr[11]/td[5]/a
'''